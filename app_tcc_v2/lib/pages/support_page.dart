...
class _SupportPageState extends State<SupportPage> {
  ...
  Future<void> fetchDataFromApi() async {
    try {
      final response = await ApiUtils.fetchData('supportmaterial');
      setState(() {
        materials =
  ...
  Widget buildExerciseList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final materialFileName = material['nomeMa'];
        final materialFileData = material['pdfMa'];
                    ...
                    SizedBox(
                      ...
                      child: Transform.scale(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            downloadPdf(materialFileData, materialFileName);
                          },
                        ),
                      ),
                    ),
